...
def parse_lottery_ticket(lottery_string, string_length):
    """
    ...
    """
    lottery_ticket = []
    single_digit_list = [lottery_string[i] for i in range(0,len(lottery_string))]
    double_digit_list = [lottery_string[i:i+2] for i in range(0,len(lottery_string))]
    dim = digit_count_map[string_length]
    ...
    while i < max_length:
        if double_digit_count > 0 and i+1 < max_length:
            ...
            # scenario 2
                ...
                if single_digit_list[i] not in lottery_ticket and int(single_digit_list[i] in valid_range) and entry2 not in lottery_ticket:
            ...
            # scenario 3
                ...
                if single_digit_count >= 2:
                    if single_digit_list[i] not in lottery_ticket and int(single_digit_list[i]) in valid_range:
                        lottery_ticket += [single_digit_list[i]]
                        single_digit_count -= 1
                        if single_digit_list[i+1] not in lottery_ticket and int(single_digit_list[i+1]) in valid_range:
